...
class tc_pa_090(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(tc_pa_090, self).__init__(driver)
    ...
    def priceFormatType(self):
        ...
        wait = WebDriverWait(self.driver, 60)
        price = wait.until(
            EC.element_to_be_clickable((By.XPATH, '//*[@id="ui-settings"]/fieldset/div[2]/div/select/option[1]')))
    ...
    def priceTypeItem(self):
        time.sleep(2)
        wait = WebDriverWait(self.driver, 60)
        price = wait.until(EC.element_to_be_clickable((By.XPATH, "//option[normalize-space()='Credit and Cash']")))
        price.click()
    ...
    def passwordManagerItem(self):
        time.sleep(2)
        wait = WebDriverWait(self.driver, 60)
        password = wait.until(EC.element_to_be_clickable((By.XPATH, "//option[normalize-space()='Local and Microsoft']")))
        password.click()
    ...
    def availPagesItem(self):
        time.sleep(2)
        wait = WebDriverWait(self.driver, 60)
        password = wait.until(EC.element_to_be_clickable((By.XPATH, "//div[contains(@x-placement,'top-start')]//button[@type='button'][normalize-space()='Deselect All']")))
        password.click()
    ...
    def availableReportsItem(self):
        time.sleep(2)
        wait = WebDriverWait(self.driver, 60)
        password = wait.until(EC.element_to_be_clickable((By.XPATH, "(//button[contains(@type,'button')][normalize-space()='Deselect All'])[2]")))
        password.click()
    ...
    def premProduct(self):
        wait = WebDriverWait(self.driver, 60)
        reg = wait.until(EC.element_to_be_clickable((By.XPATH, "(//label[normalize-space()='PREM'])[1]")))
        reg.click()
