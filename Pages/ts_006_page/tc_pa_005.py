...
class tc_pa_005(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(tc_pa_005, self).__init__(driver)
    ...
    def clusterInsights(self):
        wait = WebDriverWait(self.driver, 60)
        clusterInsights = wait.until(EC.visibility_of_element_located((By.XPATH, "(//i[@rel='New York'])[1]")))
        clusterInsights.click()
