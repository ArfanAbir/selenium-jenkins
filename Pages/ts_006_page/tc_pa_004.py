...
class tc_pa_004(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(tc_pa_004, self).__init__(driver)
    ...
    def bulkAIRuleButton(self):
        wait = WebDriverWait(self.driver, 60)
        bulkAI = wait.until(EC.visibility_of_element_located((By.XPATH, "(//button[@id='btnCurrentai'])[1]")))
        bulkAI.click()
