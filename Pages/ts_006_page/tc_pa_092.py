...
class tc_pa_092(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(tc_pa_092, self).__init__(driver)
    ...
    def passwordManagerItem(self):
        ...
        wait = WebDriverWait(self.driver, 60)
        password = wait.until(
            EC.element_to_be_clickable((By.XPATH, "//option[normalize-space()='Local and Microsoft']")))
        password.click()
    ...
    def e85Product(self):
        wait = WebDriverWait(self.driver, 60)
        e85 = wait.until(EC.element_to_be_clickable((By.XPATH, "(//label[normalize-space()='E85'])[1]")))
        e85.click()
