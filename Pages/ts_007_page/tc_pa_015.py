...
class tc_pa_015(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(tc_pa_015, self).__init__(driver)
    ...
    def selectProduct(self):
        ...
        reg = wait.until(EC.visibility_of_element_located(
            (By.XPATH, "//*[@id='ruleform']/div/div/div[1]/div[2]/div[1]/div/span/div/ul/li[4]/a/label")))
        reg.click()
    ...
    def refProductSelect(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[4]/div/span/div/ul/li[9]/a/label')))
        product.click()
    ...
    def referenceCalcType(self):
        wait = WebDriverWait(self.driver, 60)
        calc = wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[5]/div/span/div/ul/li[2]/a/label')))
        calc.click()
