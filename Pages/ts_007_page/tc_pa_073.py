...
class tc_pa_073(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(tc_pa_073, self).__init__(driver)
    ...
    def selectProduct(self):
        ...
        reg = wait.until(EC.visibility_of_element_located(
            (By.XPATH, "(//label[@title='REG'][normalize-space()='REG'])[1]")))
        reg.click()
    ...
    def referenceType(self):
        ...
        competetor = wait.until(
            EC.visibility_of_element_located((By.XPATH, "(//button[@title='Competitor(Auto)'])[1]")))
        competetor.click()

    def refType(self):
        wait = WebDriverWait(self.driver, 60)
        competetor = wait.until(
            EC.visibility_of_element_located((By.XPATH, "(//label[normalize-space()='Competitor(Auto)'])[1]")))
        competetor.click()

    def competetorType(self):
        wait = WebDriverWait(self.driver, 60)
        type = wait.until(
            EC.visibility_of_element_located((By.XPATH, "(//button[@title='Self'])[1]")))
        type.click()
    ...
    def refProduct(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(EC.visibility_of_element_located((By.XPATH, "(//button[@title='Not Defined'])[1]")))
        product.click()

    def refProductSelect(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(
            EC.visibility_of_element_located((By.XPATH, "(//label[normalize-space()='PREM Credit'])[1]")))
        product.click()

    def referenceCalculation(self):
        wait = WebDriverWait(self.driver, 60)
        calc = wait.until(EC.visibility_of_element_located((By.XPATH, "(//button[@title='Average'])[1]")))
        calc.click()

    def referenceCalcType(self):
        wait = WebDriverWait(self.driver, 60)
        calc = wait.until(
            EC.visibility_of_element_located((By.XPATH, "(//label[normalize-space()='Weighted avg'])[1]")))
        calc.click()

    def plusIcon(self):
        wait = WebDriverWait(self.driver, 60)
        plus = wait.until(EC.visibility_of_element_located((By.XPATH, "(//label[@for='optionminus'])[1]")))
        plus.click()
    ...
    def test(self):
        wait = WebDriverWait(self.driver, 60)
        test = wait.until(EC.visibility_of_element_located((By.XPATH, "(//button[@id='testrule'])[1]")))
        test.click()
    ...
    def scrollDown(self):
        ...
        scrollPoint = wait.until(
            EC.visibility_of_element_located((By.XPATH, "(//h5[normalize-space()='Select Execution Dates'])[1]")))
        self.driver.execute_script("arguments[0].scrollIntoView();", scrollPoint)

    def roleStartDate(self, date):
        wait = WebDriverWait(self.driver, 60)
        startDate = wait.until(EC.visibility_of_element_located((By.XPATH, "(//input[@id='rulestart'])[1]")))
        startDate.send_keys(date)

    def roleEndDate(self, date):
        wait = WebDriverWait(self.driver, 60)
        startDate = wait.until(EC.visibility_of_element_located((By.XPATH, "(//input[@id='ruleend'])[1]")))
        startDate.send_keys(date)

    def rolePublishTime(self, time):
        wait = WebDriverWait(self.driver, 60)
        startDate = wait.until(EC.visibility_of_element_located((By.XPATH, "(//input[@id='rulepublish1'])[1]")))
        startDate.send_keys(time)

    def rolePublishButton(self, time):
        wait = WebDriverWait(self.driver, 60)
        startDate = wait.until(EC.visibility_of_element_located((By.XPATH, "(//button[@id='btnSubmitSettings'])[2]")))
        startDate.send_keys(time)
