...
class tc_pa_065(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(tc_pa_065, self).__init__(driver)
    ...
    def refProductSelect(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(
            EC.visibility_of_element_located((By.XPATH, "(//label[normalize-space()='REG Credit'])[1]")))
        product.click()
    ...
    def referenceCalcType(self):
        wait = WebDriverWait(self.driver, 60)
        calc = wait.until(EC.visibility_of_element_located((By.XPATH, "(//label[normalize-space()='Weighted avg'])[1]")))
        calc.click()

    def plusIcon(self):
        wait = WebDriverWait(self.driver, 60)
        plus = wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[7]/div/label[2]')))
        plus.click()
