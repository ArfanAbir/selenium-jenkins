...
class tc_pa_069(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(tc_pa_069, self).__init__(driver)
    ...
    def selectProduct(self):
        ...
        reg = wait.until(EC.visibility_of_element_located(
            (By.XPATH, "(//label[@title='PREM'][normalize-space()='PREM'])[1]")))
        reg.click()
    ...
    def refProductSelect(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(
            EC.visibility_of_element_located((By.XPATH, "(//label[normalize-space()='MID Credit'])[1]")))
        product.click()
