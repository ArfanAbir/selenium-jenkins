...
class tc_pa_021(HomePage):
    ...
    def refProductSelect(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[4]/div/span/div/ul/li[6]/a/label')))
        product.click()
    ...
    def referenceCalcType(self):
        wait = WebDriverWait(self.driver, 60)
        calc = wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[5]/div/span/div/ul/li[3]/a/label')))
        calc.click()
